...
public class NaverController { 
	private final static String CLIENT_ID = "RfGcCZnltonIYA14PB0U";
	private final static String CLIENT_SECRET = "C6wjkh1DR8!";
	private final static String REDIRECT_URI = "http://localhost:8084/naverLogin";
